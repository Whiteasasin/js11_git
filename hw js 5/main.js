...
// task 2 
// let answers = [prompt(), prompt(), prompt()];
// alert (answers);
...
//   const newMassive = massive.map(subarray => subarray.slice(1));
...
// alert("Начальный масив :" + arr);
// alert("Масив в противоположном :" + reversedArr);
