...
///task 10 way 1 
// const inputString = prompt('Введіть текст з посиланням на відео на YouTube:');
// const regex = /youtube\.com\/watch\?v=([\w-]+)/;
// const match = inputString.match(regex);
// if (match) {
//   const videoId = match[1];
//   const embedCode = `<iframe width="560" height="315" src="https://www.youtube.com/embed/${videoId}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>`;
//   document.write(embedCode);
// } else {
//   alert('Посилання на відео не знайдено!');
// }
